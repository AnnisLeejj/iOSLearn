...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self configureCell:cell withEvent:note];
    return cell;
}
...
//    }
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        [noteDao delete:self.notes[indexPath.row]];
           //重新查询所有数据
           self.notes = [noteDao findAll];
        [tableView deleteRowsAtIndexPaths:@[indexPath] withRowAnimation:true];
       }
}


- (void)configureCell:(UITableViewCell *)cell withEvent:(Note *)note {
